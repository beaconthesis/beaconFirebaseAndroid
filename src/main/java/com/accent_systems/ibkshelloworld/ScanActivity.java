...
public class ScanActivity extends AppCompatActivity {
    ...
    ArrayList <String> scannedDeivcesList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button = (LinearLayout) findViewById(R.id.showMapBtn);
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent startNotifDemoActivity = new Intent(ScanActivity.this, MapsActivity.class);
                //intent.putExtra("beaconList", "texto");
                startNotifDemoActivity.putExtra( "callingActivity", 1);
                //startNotifDemoActivity.putStringArrayListExtra("beaconList",scannedDeivcesList);
                startNotifDemoActivity.putStringArrayListExtra("beaconList",scannedDeivcesList);
                startNotifDemoActivity.putStringArrayListExtra("nameList",nameList);
                startNotifDemoActivity.putExtra("RssiList",RssiList);
                startNotifDemoActivity.putStringArrayListExtra("addressList",addressList);
        ...
        public void onScanResult(int callbackType, ScanResult result) {
            ...
            for(int i=0; i<scannedDeivcesList.size(); i++){
                if(scannedDeivcesList.get(i).contains(result.getDevice().getAddress())){
                    ...
                    scannedDeivcesList.set(i, result.getRssi()+"  "+result.getDevice().getAddress()+")");
                    break;
                }
            }
            ...
            if(!contains){
                ...
                scannedDeivcesList.add(result.getRssi()+ "$"+result.getDevice().getName()+ "$"+result.getDevice().getAddress());
